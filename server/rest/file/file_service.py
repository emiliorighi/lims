...
def download_project_model_files(project_id, model_name, type):
    # Get all file links for the project and model
    links = FileLink.objects(project_id=project_id, model_name=model_name, type=type)
    if not links:
    ...
    with tempfile.NamedTemporaryFile(suffix='.zip', delete=False) as temp_file:
        ...
        return send_file(
            ...
            as_attachment=True,
            download_name=f"{project_id}_{model_name}_{type}_files.zip"
        )
