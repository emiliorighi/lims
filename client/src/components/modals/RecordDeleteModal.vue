<template>
    <VaModal v-model="recordStore.showDeleteConfirmation" close-button hide-default-actions>
        <template #header>
            <h3 class="va-h3">
                Deleting {{ idToDelete }}
            </h3>
        ...
        <template #footer>
            <div class="row justify-space-between">
                <div class="flex">
                    <VaButton @click="recordStore.showDeleteConfirmation = !recordStore.showDeleteConfirmation"
