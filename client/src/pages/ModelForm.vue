                        ...
                        <div class="flex lg12 md12 sm12 xs12">
                            <VaCard>
                                <VaCardContent>
                                    ...
                                    <ModelReference v-if="modelNames.length > 0" :models="modelNames"
...
import ModelInfo from '../components/forms/ModelInfo.vue';
import ModelAttributes from '../components/forms/ModelAttributes.vue';
import ModelIdentifier from '../components/forms/ModelIdentifier.vue';
import ModelReference from '../components/forms/ModelReference.vue';
