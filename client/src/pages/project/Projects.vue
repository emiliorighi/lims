            ...
            <VaCardContent>
                <div class="row align-center justify-space-between">
                    <div class="flex lg4 md4">
                        <VaInput v-model="searchForm.filter" placeholder="Search project"><template #appendInner>
                                <VaIcon name="search" />
                            </template>
                        </VaInput>
                    </div>
                ...
                <div class="row align-center justify-space-between">
                    ...
                    <div class="flex">
                        <Pagination @offset-changed="handlePagination" :limit="searchForm.limit"
                            :offset="searchForm.offset" :total="total" />
                    </div>
                </div>
            </VaCardContent>
        </VaCard>
