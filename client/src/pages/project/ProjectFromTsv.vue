        ...
        <div class="flex lg12 md12 sm12 xs12">
            <va-card>
                ...
                <va-card-content>
                    <va-form tag="form">
                        <ProjectAttributes />
                        <va-file-upload dropzone dropzone-text="Upload a TSV file" v-model="tsv" file-types=".tsv"
                            type="single" undo>
                        </va-file-upload>
                        <va-alert color="danger" v-if="headerError">Header length is less then first row
                            length!</va-alert>
                        <va-data-table v-else sticky-header :items="rows" :columns="header">
                            <template #headerAppend>
                                <tr class="table-crud__slot">
                                    <th v-for="c in header" class="p-1">
