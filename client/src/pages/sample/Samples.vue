<template>
    <div>
        ...
        <div v-if="schemaStore.schema.project_id" class="row row-equal">
                    ...
                    <VaCardContent class="row justify-space-between">
                        <div class="flex">
                            <TableFilters :columns="columns" :fields="schemaStore.schema.sample.fields"
                                @on-form-change="updateSearchForm" @on-show-field-change="updateShowFields" />
                        </div>
                        <div class="flex">
                            <SampleListActions />
                        </div>
            ...
            {{ sampleStore.sample }}
            <SampleFormModal @on-sample-edited="reset" />
        </div>
    </div>
</template>
...
async function handleSubmit() {
    ...
    await getSamples({ ...validFilters, ...sortFields, ...sampleStore.pagination })
}
