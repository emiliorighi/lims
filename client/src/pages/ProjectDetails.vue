<template>
    <div>
                ...
                <div class="row align-center">
                    <div class="flex mr-2">
                        <VaButton 
                            ...
                            @click="projectStore.showArchiveModal = true"
                    ...
                    <div class="flex">
                        <VaButton 
                            :disabled="isArchived || projectStore.isLoading"
                            @click="modelStore.showCreateModal = true"
                            color="primary"
                            icon="fa-plus"
                        >
                            New Model
                        ...
                        <VaCardContent>
                            <div class="row align-center">
                                ...
                                <ModelStatItem
                                    ...
                                    :model-name="model.name"
                                    :project-id="projectId"
                                    :value="modelStats[model.name]?.protocols"
                                />
                                <ModelStatItem
                                    label="Images"
                                    route-name="images"
                                    :model-name="model.name"
                                    :project-id="projectId"
                                    :value="modelStats[model.name]?.images"
                                />
                            </div>
                        </VaCardContent>
                    </VaCard>
        ...
        <ModelFormModal 
            v-model="modelStore.showCreateModal" 
            mode="create" 
            :existing-models="projectStore.models"
            :is-project-form="false" 
            @submit="handleNewModel" 
        />
    </div>
</template>
